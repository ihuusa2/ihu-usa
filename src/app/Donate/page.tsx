                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
                        ...
                        <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white p-6">
                            ...
                            <p className="text-orange-100 mt-2">Secure payment powered by PayPal</p>
                        </div>

                        {/* Content */}
                        <div className="p-6">
                            {/* Donation Summary */}
                            <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 mb-6 border border-orange-200">
                                <h3 className="font-bold text-gray-800 mb-4 text-lg">Donation Summary</h3>
