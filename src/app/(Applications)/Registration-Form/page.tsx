                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pr-10 border rounded-xl focus:ring-2 focus:border-blue-500 transition-all duration-200 text-base bg-white shadow-sm hover:shadow-md ${
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:border-blue-500 transition-all duration-200 text-base bg-white shadow-sm hover:shadow-md ${
